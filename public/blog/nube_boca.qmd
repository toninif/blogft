...
> **Tip:** Puedes cambiar `size`, `color`, `backgroundColor` e incluso el `shape` (por ejemplo, `shape = "star"`) para personalizar tu nube.
...
¡Listo! Has aprendido a crear y personalizar una nube de palabras en R con `wordcloud2`. Este tutorial es ideal para tu blog y puede adaptarse a cualquier corpus de texto.
